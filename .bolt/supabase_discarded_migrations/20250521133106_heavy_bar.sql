/*
  # Fix RLS Policies for KYC Tables

  1. Changes
    - Update RLS policies for kyc_submissions table
    - Update RLS policies for kyc_documents table
    - Add storage policies for kyc_documents bucket
  
  2. Security
    - Enable RLS on both tables
    - Add policies for authenticated users to manage their own submissions
    - Add policies for admin users to manage all submissions
