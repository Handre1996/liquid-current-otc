  ...
  const steps = [
    {
      ...
      title: "Register",
      description:
        "Create an account with your email address and basic information.",
    },
    {
      number: 2,
      title: "Upload Documents",
      description:
        "Submit your identification and proof of address documents through our secure portal.",
    },
    {
      number: 3,
      title: "Verification",
      description:
        "Our team will review your documents for compliance with FSCA regulations.",
    },
    {
      number: 4,
      title: "Approval",
      description:
        "Once approved, you'll receive confirmation and can begin trading.",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl text-xl font-body text-teal dark:text-foam/80 mx-auto">
            Complete our Know Your Customer process once to trade with
            confidence through Liquid Current OTC Desk.
          </p>
        </div>
        ...
        {/* Required documents */}
        <div className="mt-16 bg-teal rounded-lg shadow-lg border border-foam/50 dark:border-teal/30 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-teal/20 to-transparent"></div>
            </div>
