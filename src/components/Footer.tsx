          ...
          <div className="flex flex-col items-center justify-center">
            <div className="mb-4">
              <img 
                ...
                alt="Liquid Current" 
                className="h-32 w-auto opacity-80 hover:opacity-100 transition-opacity duration-200"
              />
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-brand-700 dark:border-brand-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 flex space-x-4">
              <a href="#" className="text-brand-100 dark:text-brand-200 hover:text-white dark:hover:text-brand-100 transition-colors">
