    ...
    >
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="mb-4">
              {isAboutPage ? (
                <img 
                  ...
                  alt="Liquid Current" 
                  className="h-40 w-auto opacity-80 hover:opacity-100 transition-opacity duration-200"
                />
              ) : (
                <img 
          ...
          {/* Quick Links */}
          <div>
            <h3 className={`text-lg font-semibold font-heading font-bold ${isAboutPage ? 'text-foam' : 'text-navy dark:text-navy'}`}>
              Quick Links
            </h3>
