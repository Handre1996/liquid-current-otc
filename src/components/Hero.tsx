    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-navy via-teal to-navy dark:from-navy dark:via-teal dark:to-navy text-blanc">
      ...
      <div className="absolute inset-0">
        <img
          src="/beautiful.jpg"
          alt="Background"
          className="w-full h-full object-cover sm:scale-100 sm:[object-position:80%_20%] scale-100 [object-position:center]"
        ...
        <div className="max-w-4xl">
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="mt-4 text-xs sm:text-sm text-navy dark:text-foam font-body px-2 py-1 rounded 
                            bg-white/70 dark:bg-navy/70 backdrop-blur-sm inline-block 
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-transparent to-transparent"></div>
    </div>
  );
}
